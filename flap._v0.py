...
# Main menu function
def main_menu():
    title_text = font.render("FLAPPY BIRD M1 PORT", True, WHITE)
    sub_title_text = small_font.render("[C] @Flames Team [C] 20XX-25", True, WHITE)
    ...
    while running:
        ...
        screen.blit(sub_title_text, (SCREEN_WIDTH // 2 - sub_title_text.get_width() // 2, SCREEN_HEIGHT // 2 - 50))
...
if __name__ == "__main__":
    ...
    main_game()  # Run the main game after the menu
